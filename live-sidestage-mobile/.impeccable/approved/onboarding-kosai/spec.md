...
- 0 見出し「画面を見ずに、声で聞く」 / 本文「企画中で画面が見れない時も、配信ソフトから目を離したまま応答できます。リスナーごとに別々の声を割り当てて、読み上げを華やかにすることもできます。」
- 1 見出し「ギフトが届いたら、音でわかる」 / 本文「受け取ったギフトに合わせた効果音を鳴らせます。配信中も片手で対応表を触れます。」
- 2 見出し「画面オフでも、途切れない」 / 本文「読み上げと効果音はバックグラウンドでも続きます。」
- 3 見出し「貢献とギフトを、あとから見る」 / 本文「貢献タブでランキング、ギフト履歴タブで受信一覧を確認できます。日付やリスナー名で絞り込めます。」
- 4 見出し「バトル履歴も、ここで確認」 / 本文「バトルタブに対戦結果が溜まります。タップすると、そのバトルの貢献者も見られます。」
