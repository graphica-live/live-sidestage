...
const eventModalVdjEffectType = document.getElementById('event-modal-vdj-effect-type');
const eventModalVdjTargetDeck = document.getElementById('event-modal-vdj-target-deck');
