...
const eventModalLsCameraAutoOffRow = document.getElementById('event-modal-ls-camera-auto-off-row');
const eventModalLsCameraAutoOffEnabled = document.getElementById('event-modal-ls-camera-auto-off-enabled');
...
const eventModalTimerWidgetEnabled = document.getElementById('event-modal-timer-widget-enabled');
const eventModalTimerWidgetMode = document.getElementById('event-modal-timer-widget-mode');
const eventModalTimerWidgetFixedRow = document.getElementById('event-modal-timer-widget-fixed-row');
const eventModalTimerWidgetMinutes = document.getElementById('event-modal-timer-widget-minutes');
const eventModalTimerWidgetReversalRow = document.getElementById('event-modal-timer-widget-reversal-row');
const eventModalTimerWidgetThreshold = document.getElementById('event-modal-timer-widget-threshold');
const eventModalTimerWidgetBelowMinutes = document.getElementById('event-modal-timer-widget-below-minutes');
const eventModalTimerWidgetAboveMinutes = document.getElementById('event-modal-timer-widget-above-minutes');
const eventModalForceInterruptEnabled = document.getElementById('event-modal-force-interrupt-enabled');
const eventModalForceInterruptCountRow = document.getElementById('event-modal-force-interrupt-count-row');
const eventModalForceInterruptCount = document.getElementById('event-modal-force-interrupt-count');
const eventModalX5Activate = document.getElementById('event-modal-x5-activate');
const eventModalX6Activate = document.getElementById('event-modal-x6-activate');
...
const triggerModalX6Included = document.getElementById('trigger-modal-x6-included');
