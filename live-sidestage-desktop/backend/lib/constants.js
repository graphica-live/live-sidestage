...
const EFFECT_CATEGORIES_STATE_KEY = 'effect_categories';
const EFFECT_DEFAULT_CATEGORY_ID = 'default';
const EFFECT_DEFAULT_CATEGORY_NAME = '初期';
...
const WIDGET_GOAL_GIFTS_LAYOUT_STATE_KEY = 'widget_goal_gifts_layout';
const WIDGET_GOAL_GIFTS_HEADING_TEXT_STATE_KEY = 'widget_goal_gifts_heading_text';
const WIDGET_GOAL_GIFTS_HEADING_SCROLL_STATE_KEY = 'widget_goal_gifts_heading_scroll';
const WIDGET_GOAL_GIFTS_HEADING_FONT_SIZE_STATE_KEY = 'widget_goal_gifts_heading_font_size';
const WIDGET_GOAL_GIFTS_PROGRESS_RING_COLOR_STATE_KEY = 'widget_goal_gifts_progress_ring_color';
const WIDGET_GOAL_GIFTS_PROGRESS_BG_OPACITY_STATE_KEY = 'widget_goal_gifts_progress_bg_opacity';
...
const WIDGET_TAP_GOAL_SETTINGS_STATE_KEY = 'widget_tap_goal_settings';
const WIDGET_TAP_GOAL_PROGRESS_STATE_KEY = 'widget_tap_goal_progress';
const WIDGET_TAP_GOAL_FONT_STATE_KEY = 'widget_tap_goal_font';
const WIDGET_TAP_GOAL_TEXT_STYLE_STATE_KEY = 'widget_tap_goal_text_style';
const WIDGET_TAP_GOAL_STROKE_WIDTH_STATE_KEY = 'widget_tap_goal_stroke_width';
const WIDGET_TIMER_SETTINGS_STATE_KEY = 'widget_timer_settings';
const WIDGET_TIMER_STATE_KEY = 'widget_timer_runtime';
const WIDGET_TIMER_FONT_STATE_KEY = 'widget_timer_font';
...
const WIDGET_TRIGGER_X6_SETTINGS_STATE_KEY = 'widget_trigger_x6_settings';
...
const EFFECT_TRIGGER_FOLLOW_GIFT_IMAGE_URL = `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(`
...
const EXPORTABLE_SCOPED_SETTINGS_KEYS = [
    ...
    WIDGET_GOAL_GIFTS_PROGRESS_BG_OPACITY_STATE_KEY,
    ...
    WIDGET_TAP_GOAL_FONT_STATE_KEY,
    WIDGET_TAP_GOAL_TEXT_STYLE_STATE_KEY,
    WIDGET_TAP_GOAL_STROKE_WIDTH_STATE_KEY,
    WIDGET_TIMER_SETTINGS_STATE_KEY,
    WIDGET_TIMER_STATE_KEY,
    WIDGET_TIMER_FONT_STATE_KEY,
    ...
    WIDGET_TRIGGER_X6_SETTINGS_STATE_KEY,
];
...
const DEFAULT_GOAL_GIFT_WIDGET_LAYOUT = 'row';
const ALLOWED_GOAL_GIFT_WIDGET_LAYOUTS = new Set(['row', 'column']);
const DEFAULT_GOAL_GIFT_WIDGET_HEADING_TEXT = '';
const MAX_GOAL_GIFT_WIDGET_HEADING_TEXT_LENGTH = 40;
const DEFAULT_GOAL_GIFT_WIDGET_HEADING_SCROLL = false;
const DEFAULT_GOAL_GIFT_WIDGET_HEADING_FONT_SIZE = 32;
const MIN_GOAL_GIFT_WIDGET_HEADING_FONT_SIZE = 12;
const MAX_GOAL_GIFT_WIDGET_HEADING_FONT_SIZE = 160;
const DEFAULT_GOAL_GIFT_WIDGET_PROGRESS_RING_COLOR = '#f59e0b';
const DEFAULT_GOAL_GIFT_WIDGET_PROGRESS_BG_OPACITY = 46;
const MIN_GOAL_GIFT_WIDGET_PROGRESS_BG_OPACITY = 0;
const MAX_GOAL_GIFT_WIDGET_PROGRESS_BG_OPACITY = 100;
...
module.exports = {
    ...
    DEFAULT_GOAL_GIFT_WIDGET_PROGRESS_RING_COLOR,
    DEFAULT_GOAL_GIFT_WIDGET_PROGRESS_BG_OPACITY,
    MIN_GOAL_GIFT_WIDGET_PROGRESS_BG_OPACITY,
