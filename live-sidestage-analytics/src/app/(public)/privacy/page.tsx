    ...
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="mt-8 space-y-10">
        <Section title="1. 取得する情報">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              なお配信者の操作により、特定のバトルについて、その時点の貢献内容(ニックネーム・アイコン・ギフトの種類と金額)を第三者が閲覧できる公開リンクを発行できます(下記3.を参照)。
            </li>
            <li>
        ...
        <Section title="3. 第三者への提供・共有">
          ...
          <p>
            配信者は、自身のバトル1件ごとに公開リンク(共有URL)を発行できます。このリンクを知っている方は、ログインなしでそのバトルの再生と貢献者一覧(視聴者のニックネーム・アイコン・ギフトの種類と金額)を閲覧できます。公開リンクには視聴者のTikTokハンドルは含めず、検索エンジンの索引対象にもしません。発行するかどうかは配信者の操作によります。
          </p>
        </Section>
