...
//                       resolveAgencyByApiKey()が唯一の境界になる。セッション認証の
...
export const config = {
  matcher: [
    "/((?!login(?:/|$)|register(?:/|$)|e(?:/|$)|api/auth(?:/|$)|api/public(?:/|$)|api/mobile(?:/|$)|api/health(?:/|$)|api/debug(?:/|$)|api/internal(?:/|$)|api/analytics/monthly-contributors(?:/|$)|api/agency/gifts(?:/|$)|api/overlay(?:/|$)|overlay(?:/|$)|_next/static(?:/|$)|_next/image(?:/|$)|favicon.ico$).*)",
  ],
};
