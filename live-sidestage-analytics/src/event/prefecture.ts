// 都道府県。JIS X 0401 の全国地方公共団体コード上2桁("01".."47")をそのまま使う。
// teamPreset = "PREFECTURE" のイベントで EventTeam.prefectureCode に入る。
//
// フェーズ6で日本地図UI(SVG)を足すときも、このコードを図形の id に対応させる。

export type Prefecture = { code: string; name: string; region: string };
...
export function findPrefecture(code: string): Prefecture | null {
