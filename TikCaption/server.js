...
const DEFAULT_SETTINGS = {
  ...
  ttsFilterRules: [
    ...
    { pattern: 'しね',       mode: 'skip', replacement: '' },
    { pattern: 'シネ',       mode: 'skip', replacement: '' },
    { pattern: 'タヒね',     mode: 'skip', replacement: '' },
    { pattern: '殺す',       mode: 'skip', replacement: '' },
    { pattern: 'ころす',     mode: 'skip', replacement: '' },
    { pattern: 'コロス',     mode: 'skip', replacement: '' },
    { pattern: '自殺',       mode: 'skip', replacement: '' },
    { pattern: 'じさつ',     mode: 'skip', replacement: '' },
    { pattern: 'リスカ',     mode: 'skip', replacement: '' },
    { pattern: 'リストカット', mode: 'skip', replacement: '' },
    { pattern: '首吊り',     mode: 'skip', replacement: '' },
    { pattern: 'くびつり',   mode: 'skip', replacement: '' },
    { pattern: 'ころがす',   mode: 'skip', replacement: '' },
    // 【差別的表現・深刻な誹謗中傷】
    { pattern: 'ガイジ',     mode: 'skip', replacement: '' },
    { pattern: 'がいじ',     mode: 'skip', replacement: '' },
    { pattern: '障害',       mode: 'skip', replacement: '' },
    { pattern: 'しょうがい', mode: 'skip', replacement: '' },
    { pattern: '池沼',       mode: 'skip', replacement: '' },
    { pattern: 'ちしょう',   mode: 'skip', replacement: '' },
    { pattern: '奇形',       mode: 'skip', replacement: '' },
    { pattern: 'きけい',     mode: 'skip', replacement: '' },
    { pattern: 'ブス',       mode: 'skip', replacement: '' },
    { pattern: 'ぶす',       mode: 'skip', replacement: '' },
    { pattern: 'デブ',       mode: 'skip', replacement: '' },
    { pattern: 'でぶ',       mode: 'skip', replacement: '' },
    { pattern: 'ハゲ',       mode: 'skip', replacement: '' },
    { pattern: 'はげ',       mode: 'skip', replacement: '' },
    { pattern: '消えろ',     mode: 'skip', replacement: '' },
    { pattern: 'きえろ',     mode: 'skip', replacement: '' },
    // 【違法薬物・処方薬乱用系】
    { pattern: '覚醒剤',     mode: 'skip', replacement: '' },
    { pattern: '覚せい剤',   mode: 'skip', replacement: '' },
    { pattern: 'かくせいざい', mode: 'skip', replacement: '' },
    { pattern: '大麻',       mode: 'skip', replacement: '' },
    { pattern: 'たいま',     mode: 'skip', replacement: '' },
    { pattern: 'マリファナ', mode: 'skip', replacement: '' },
    { pattern: 'ガンジャ',   mode: 'skip', replacement: '' },
    { pattern: 'ハッパ',     mode: 'skip', replacement: '' },
    { pattern: 'コカイン',   mode: 'skip', replacement: '' },
    { pattern: 'ヘロイン',   mode: 'skip', replacement: '' },
    { pattern: 'シャブ',     mode: 'skip', replacement: '' },
    { pattern: 'ポン中',     mode: 'skip', replacement: '' },
    { pattern: 'オーバードーズ', mode: 'skip', replacement: '' },
    { pattern: 'OD',         mode: 'skip', replacement: '' },
    { pattern: 'オーディー', mode: 'skip', replacement: '' },
    { pattern: '睡眠薬',     mode: 'skip', replacement: '' },
    { pattern: 'すいみんやく', mode: 'skip', replacement: '' },
    { pattern: '眠剤',       mode: 'skip', replacement: '' },
    { pattern: 'みんざい',   mode: 'skip', replacement: '' },
    { pattern: '合法ハーブ', mode: 'skip', replacement: '' },
    { pattern: '脱法ハーブ', mode: 'skip', replacement: '' },
  ],
  ttsVoiceMapping: [],
  ttsConversionRules: [],
  ttsEmojiRules: [],
